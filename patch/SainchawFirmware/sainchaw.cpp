...
// void Sainchaw::DelayMs(size_t del) { seed.DelayMs(del); }
...
// void Sainchaw::StartAudio(AudioHandle::AudioCallback cb) { seed.StartAudio(cb); }

// void Sainchaw::ChangeAudioCallback(AudioHandle::AudioCallback cb) {
//   seed.ChangeAudioCallback(cb);
// }

// void Sainchaw::StopAudio() { seed.StopAudio(); }
...
// float Sainchaw::AudioSampleRate() { return seed.AudioSampleRate(); }
...
// size_t Sainchaw::AudioBlockSize() { return seed.AudioBlockSize(); }

// float Sainchaw::AudioCallbackRate() { return seed.AudioCallbackRate(); }

// void Sainchaw::StartAdc() { seed.adc.Start(); }

// /** Stops Transfering data from the ADC */
// void Sainchaw::StopAdc() { seed.adc.Stop(); }


// void Sainchaw::ProcessAnalogControls() {
//   for(size_t i = 0; i < CTRL_LAST; i++) { controls[i].Process(); }
// }
// float Sainchaw::GetKnobValue(Ctrl k) { return (controls[k].Value()); }

// void Sainchaw::ProcessDigitalControls() { encoder.Debounce(); }
...
//   encoder.Init(
//       seed.GetPin(PIN_ENC_A), seed.GetPin(PIN_ENC_B), seed.GetPin(PIN_ENC_CLICK));
// }

// void Sainchaw::SetNoteLed(bool state) { dsy_gpio_write(&note_led, state); }

// void Sainchaw::SetAltLed(bool state) { dsy_gpio_write(&note_led, state); }
